import { GlobeDemo } from './DemoGlobe.tsx';
  ...
  return (
    <section className=" flex sm:flex-row flex-col h-[calc(100vh_-_5rem)] items-center ">
      <div className="flex-1 ">
        ...
        <h1 className="font-bold text-6xl">Hi, I'm Plamen Ermenkov</h1>
        <p className="opacity-75">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fuga
          asperiores libero dolor porro harum? Minima, atque eligendi porro
          voluptatibus quisquam nihil maxime ut, voluptates vel, non a
          doloremque! Optio, quo!
        </p>
